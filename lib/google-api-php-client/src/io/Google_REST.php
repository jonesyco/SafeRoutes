...
class Google_REST {
  ...
  public static function decodeHttpResponse($response) {
    ...
    if ($code != '200' && $code != '201' && $code != '204') {
      # added by Falk because of poor cooding of this API
      $body = str_replace('NaN,','"NaN",', $body);
    ...
    if ($code != '204') {
      # added by Falk because of poor cooding of this API, incorrect JSON response
      $body = str_replace('NaN,','"NaN",', $body);
      $decoded = json_decode($body, true);
